...
export OPAL_TOOLS_JAVA_ARGS="-Dlog4j.configurationFile=${OPAL_TOOLS_HOME_DIR}/conf/log4j2.xml -Djava.util.logging.config.file=${OPAL_TOOLS_HOME_DIR}/conf/log4j.properties"

# for debugging, use these log file settings
# export OPAL_TOOLS_JAVA_ARGS="-Dlog4j.configurationFile=${OPAL_TOOLS_HOME_DIR}/conf/log4j2-debug.xml -Djava.util.logging.config.file=${OPAL_TOOLS_HOME_DIR}/conf/log4j-debug.properties"
